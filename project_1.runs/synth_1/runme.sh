...
HD_PWD='E:/git/repositories/testgit/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_recover.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reset_recover.tcl
